...
<section id="credencial">
    <section class="dados card" onclick="chama_checkin_evento(<%=id_projeto%>, '<%=nome%>', '<%=empresa%>', '<%=checkin%>')">
            ...
            <div id='inputs'>
                <div class="carousel carousel-slider">
                    <div class="input-field carousel-item">
                        <%if(fez_checkin == 1){%>
                        <input disabled placeholder="Nome para credencial" maxlength="22" id="name_input" type="text" value="<%= nome %>">
                         <%}else{%>
                    ...
                    <div class="input-field carousel-item">
                    <%if(fez_checkin == 1){%>
                        <input disabled placeholder="Empresa" id="empresa_input" maxlength="16" type="text" value="<%= empresa %>">
                    <%}else{%>
...
function chama_checkin_evento(id_projeto, nome, empresa, fez_checkin) {
        ...
        if (err) {
            ...
            if (id_projeto == text) {
                ...
                QRScanner.destroy(function (status) {
                    ...
                    open_finalizar_credencial(nome, empresa, text, id_projeto, fez_checkin);
                });
            } else {
...
function open_finalizar_credencial(nome, empresa, text, id_projeto, fez_checkin) {
    change_view(tela_credencial_finalizar, true, true, {
        nome: nome,
        empresa: empresa,
        fez_checkin: fez_checkin,
    }, false, {});
