...
//                         <div class="estrutura-curso" style="margin-top: 4%; margin-bottom: 15%; box-shadow: 1px 1px 30px #d3d3d3; border-radius: 15px;">
//                         <div class="flex jc-sb"> 
//                             <div class="subtitulo-estrutura-curso wrap-sign">
//                                 <%= modulos[modulo].modulo %>
//                                  </div>
//                                  <div class="wrap-sign">
//                             <i class="fa fa-plus violet-point" aria-hidden="true"></i>
//                             <i class="fa fa-minus violet-point" aria-hidden="true"></i>
//                             </div>
//                               </div>
//                             <div class="div-texto-estrutura">
//                                     <%for (step of modulos[modulo].step){%>
//                                         <li class="violet-point"><span class="kjk"><%=step%></span></li>
